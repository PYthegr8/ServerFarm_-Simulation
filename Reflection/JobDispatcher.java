...
public abstract class JobDispatcher {
    ...
    protected ArrayList<PreemptiveServer> server_collection;
    ...
    public JobDispatcher(int k, boolean showViz){
        ...
        for (int i = 0; i<k; i++){
            server_collection.add(new PreemptiveServer());
        }
    ...
    public void advanceTimeTo(double param_time){
        ...
        for (PreemptiveServer server : server_collection) {
    ...
    public void handleJob(Job job){
        ...
        viz.repaint();
        PreemptiveServer chosenServer = pickServer(job);
    ...
    public abstract PreemptiveServer pickServer(Job j);
