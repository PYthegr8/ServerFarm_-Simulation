...
public class QueueTests {
    ...
    // case 14: testing findMin and removeMin
{
    // setup
    LinkedList<Integer> ll = new LinkedList<Integer>();
    ll.offer(3);
    ...
    int min = ll.findMin(comparator);
    int removedMin = ll.removeMin(comparator);

    // verify
    System.out.println(min + " == 1");
    System.out.println(removedMin + " == 1");

    // test
    assert min == 1 : "Error in LinkedList::findMin()";
    assert removedMin == 1 : "Error in LinkedList::removeMin()";
}
}
}